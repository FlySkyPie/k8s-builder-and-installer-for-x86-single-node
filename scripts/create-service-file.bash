...
if [ -f kube-apiserver.service ]; then
  echo "File 'kube-apiserver.service' exist, skip."
else
...
if [ -f kube-controller-manager.service ]; then
  echo "File 'kube-controller-manager.service' exist, skip."
else
...
if [ -f kube-scheduler.service ]; then
  echo "File 'kube-scheduler.service' exist, skip."
else
...
if [ -f kube-scheduler.yaml ]; then
  echo "File 'kube-scheduler.yaml' exist, skip."
else
